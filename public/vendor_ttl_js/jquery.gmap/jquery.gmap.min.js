! function(g) {
    g.fn.gMap = function(e, o) {
        ...
        return this.each(function() {
            ...
            function t(a) {
                return function(e, o) {
                    e && 0 < e.length && g(r).trigger("gMap.addMarker", [e[0].geometry.location.lat(), e[0].geometry.location.lng(), a.html, a.icon, a.popup])
                }
            }
            for (var r = this, i = 0; i < w.markers.length; i++)(s = w.markers[i]).address ? ("_address" === s.html && (s.html = s.address), e.geocode({
                address: s.address
            }, t(s))) : g(this).trigger("gMap.addMarker", [s.latitude, s.longitude, s.html, s.icon, s.popup])
        })
    }, g.fn.gMap.defaults = {
        address: "",
        latitude: 0,
