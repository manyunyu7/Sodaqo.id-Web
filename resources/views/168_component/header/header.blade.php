        ...
        <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media me-2">
                                                <img alt="image" width="50" src="{{ asset('/168_res') }}/images/avatar/1.jpg">
                                            </div>
                    ...
                    <li class="nav-item">
                        <a href="{{ url('/logout') }}" class="btn btn-primary d-sm-inline-block d-none">Logout<i class="place icon here"></i></a>
                    </li>
                </ul>
            </div>
        </nav>
