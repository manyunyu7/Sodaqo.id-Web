    ...
    <div class="content-body" style="min-height: 798px;">
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Kategori Program</a></li>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Kategori Program di {{config("app.name")}}</h4>
                            <div class="p-0">
                                <a href="{{url("sodaqo-category/create")}}" class="btn btn-outline-primary btn-block">Tambah
                                    Baru</a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="168dt" class="display" style="min-width: 845px">
                                    ...
                                    @forelse ($datas as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <img class="img-thumbnail" height="200px" style="border-radius: 20px"
                                            ...
                                            <td>
                                                <a href="{{url('/sodaqo-category'.'/'.$data->id.'/edit')}}">
