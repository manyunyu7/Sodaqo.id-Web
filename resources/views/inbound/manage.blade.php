            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Manage Data Material</h4>
                    </div>
                                    ...
                                    <table class="table table-striped dataTable-table" id="table_data">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-sortable="">Supplied Material</th>
                                                <th data-sortable="">Transaction Number</th>
                                                <th data-sortable="">Amount</th>
                                                <th data-sortable="">Created at</th>
                                                <th data-sortable="">Photo</th>
                                                <th data-sortable="">Cancel</th>
                                            </tr>
                                        </thead>
                                        <tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    All related data with this data will be deleted.
                </div>
...
@push('script')
    ...
    <script type="text/javascript">
        ...
        $('body').on("click", ".btn-delete", function() {
            var id = $(this).attr("id")
            $(".btn-destroy").attr("href", window.location.origin + "/inbound/" + id + "/cancel")
